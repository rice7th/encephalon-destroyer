...
macro_rules! print_title {
    () => {
        ...
        println!("A BrainFuck interpreter written by \x1b[42m\x1b[30m Rice7th \x1b[0m \x1b[32m(https://github.com/rice7th)\x1b[0m\n");
    };
}
#[allow(unused_macros)]
...
macro_rules! show_info {
    () => {{
        println!("\x1b[0m\x1b[1m\t=+=+=+=+=+= Encephalon Destroyer =+=+=+=+=+=\x1b[0m");
        println!(r#"\x1b[0mEncephalon Destroyer is a BrainFuck interpreter written by \x1b[42m\x1b[30m Rice7th \x1b[0m \x1b[32m(https://github.com/rice7th)\x1b[0m as an experiment and an exercise to learn Rust better.
                 It is highly inspired by bf, a Brainfuck interpreter written by \x1b[43m\x1b[30m Alexander Overvoorde \x1b[0m, aka Overv, \x1b[33m(https://github.com/Overv/bf)\x1b[0m.
                 There are quite a few differences between these two projects, from simple QOL features to actually game-changing ones (such as cell wrapping and the ability to customize this one a bit more).
                 
                 This project was really fun and it took me only 4 days to make, which now that I am thinking about it is actually a lot lol.
                 In the future I might add new features or completely revamp the way this interpreter works, maybe adding even a JIT compiler!
                 (OK I don't know if I will add that because JIT compilers are HARD).
